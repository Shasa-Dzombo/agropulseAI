...
#define TEST_DEVICE_NAME            "AGROPULSE_ESP32"
...
esp_err_t ble_manager_notify_sensor_data(const sensor_data_t* data) {
    // For now, we'll just log. Implementation will be added.
    ESP_LOGI(GATTS_TAG, "TODO: Notify sensor data over BLE: Temp=%.2f", data->temperature);
    return ESP_OK;
}
